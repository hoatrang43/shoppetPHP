            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="shopphukien"></i> Phụ kiện</a>
                        <span ng-repeat="t in phukienloai">@{{t.ten_loai}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseTwo">Chó cảnh</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Phụ kiện</a>
                                        </div>
                                        <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                <li ng-repeat="l in categories"ng-click="saveLoaiPK(g.id)"><a href="shop_phhukien_details">@{{l.ten_loai}}</a></li>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row">
                        <div class="col-lg-4 col-md-6" dir-paginate="sp in phukienloai|filter: timkiem |itemsPerPage:itemPerPage3">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="phukien_detail" ng-click="openDetails(sp.id)" style="text-transform:capitalize">@{{sp.ten_pk}}</a></h6>
