            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="shopdog"></i> Chó cảnh</a>
                        <span ng-repeat="t in TTGiong">@{{t.ten_giong}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Chó cảnh</a>
                                        </div>
                                        <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                <li ng-repeat="g in giongs"ng-click="saveLoai(g.id)"><a href="shopdogdetail">Chó @{{g.ten_giong}}</a></li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <ul>
                                                <li ng-repeat="l in categories"ng-click="saveLoai(l.id)"><a href="shop_phukien_details">@{{l.ten_loai}}</a></li>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row">
                        <div class="col-lg-4 col-md-6" dir-paginate="sp in dogLoai|filter: timkiem |itemsPerPage:itemPerPage3">
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="pagination__option">
                                <div class="pagination justify-content-center">
                                    ...
                                    <dir-pagination-controls max-size="6" direction-links="true" boundary-links="true" on-page-change='indexCount(newPageNumber)'>
                ...
                <div class="col-lg-12">
                    <div class="product__details__tab">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Đặc điểm</a>
                            </li>
                        </ul>
                        <div class="tab-content" ng-repeat="t in TTGiong">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <h6>Giới thiệu nguồn gốc</h6>
                                <p type="text">@{{t.thong_tin}}</p>
                                
                                <p style="text-align: center;"><img style="width: 375px" src="/image/thong_tin/@{{t.anh}}"></p>
                            </div>
