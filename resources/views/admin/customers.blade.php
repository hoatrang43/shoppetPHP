                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    <tr dir-paginate="sp in customers|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td><img src="/image/customers/@{{sp.anh}}" style='width:50px' alt=""></td>
                                        <td><a href="customer_details" ng-click="openDetails(sp.id)" style="color: #646464;">@{{sp.ten_kh}}</a></td>
                                        <td>@{{sp.sdt}}</td>
                                        <td>@{{sp.user_name}}</td>
