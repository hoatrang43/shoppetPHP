                            ...
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="sp in products|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td><a href="phukiendetails" ng-click="openDetails(sp.id)"><img src="/image/phu_kien/@{{sp.anh}}" style='width:100%' alt=""></a></td>
                                        <td><a href="phukiendetails" ng-click="openDetails(sp.id)" style="color: #646464;max-width: 10%;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">@{{sp.ten_pk}}</a></td>
                                        <td>@{{sp.loaiphukien.ten_loai}}</td>
