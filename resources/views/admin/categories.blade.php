...
<body ng-app="myapp" ng-controller="loaiphukiencontroller">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h2>Quản Lý Loại Phụ Kiện</h2> 
                    <ul>
                        <li>
                            <a href="#">Home</a>
                        </li>
                        <li>Danh sách loại phụ kiện</li>
                    </ul>                 
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    <tr dir-paginate="sp in categories|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td><a href="category_details" ng-click="openDetails(sp.id)" style="color: #646464;">@{{sp.ten_loai}}</a></td>
                                        <td>@{{sp.mo_ta}}</td>
                        ...
                        <form class="new-added-form">
                            <div class="row">
                                <div class="col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" ng-model="category.ten_loai">
                                </div>
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>Mô tả</label>
                                    <textarea class="textarea form-control" name="message" id="form-message" cols="10" rows="9" ng-model="category.mo_ta"></textarea>
    ...
    <script src="/js/loaiphukiencontroller.js"> </script>
